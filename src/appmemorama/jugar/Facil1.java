...
public class Facil1 extends javax.swing.JPanel implements Runnable {
    ...
    private static class Incrementar4 extends Thread{
    private Facil1 v;
    private int seg;
    private int min;
    private int hora;
  
    public Incrementar4(Facil1 v){
        this.v=v;
        seg = v.getSeg();
        min = v.getMin();
        hora = v.getHora(); 
