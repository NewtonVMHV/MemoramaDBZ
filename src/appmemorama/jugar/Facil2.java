...
public class Facil2 extends javax.swing.JPanel implements Runnable {
   ...
   private MatrizDimension mJ= new MatrizDimension();
    ...
    private static class Incrementar5 extends Thread{
    private Facil2 v;
    private int seg;
    private int min;
    private int hora;
  
    public Incrementar5(Facil2 v){
        this.v=v;
        seg = v.getSeg();
        min = v.getMin();
        hora = v.getHora(); 
