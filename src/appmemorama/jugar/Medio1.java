...
public class Medio1 extends javax.swing.JPanel implements Runnable {
   ...
   private int intentado = 0;
    ...
    public void cargarMatrizImg(){
         ...
         bt3.setDisabledIcon(new ImageIcon(getClass().getResource("../../appmemorama/recursos2/"+matrizJuego[1][0]+".jpg")));
         bt4.setDisabledIcon(new ImageIcon(getClass().getResource("../../appmemorama/recursos2/"+matrizJuego[1][1]+".jpg")));
         bt5.setDisabledIcon(new ImageIcon(getClass().getResource("../../appmemorama/recursos2/"+matrizJuego[2][0]+".jpg")));
         bt6.setDisabledIcon(new ImageIcon(getClass().getResource("../../appmemorama/recursos2/"+matrizJuego[2][1]+".jpg")));
         bt7.setDisabledIcon(new ImageIcon(getClass().getResource("../../appmemorama/recursos2/"+matrizJuego[3][0]+".jpg")));
         bt8.setDisabledIcon(new ImageIcon(getClass().getResource("../../appmemorama/recursos2/"+matrizJuego[3][1]+".jpg")));
    ...
    private static class Incrementar7 extends Thread{
    private Medio1 v;
    private int seg;
    private int min;
    private int hora;
  
    public Incrementar7(Medio1 v){
        this.v=v;
        seg = v.getSeg();
        min = v.getMin();
        hora = v.getHora(); 
