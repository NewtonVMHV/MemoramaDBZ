...
import java.awt.*;
import javax.swing.*;
public class Dificil extends javax.swing.JPanel implements Runnable {//Agregar la implementacion Runable. 
    ...
    public void cargarMatrizImg(){
         ...
         bt13.setDisabledIcon(new ImageIcon(getClass().getResource("../../appmemorama/recursos/"+matrizJuego[3][0]+".jpg")));
         bt14.setDisabledIcon(new ImageIcon(getClass().getResource("../../appmemorama/recursos/"+matrizJuego[3][1]+".jpg")));
         bt15.setDisabledIcon(new ImageIcon(getClass().getResource("../../appmemorama/recursos/"+matrizJuego[3][2]+".jpg")));
         bt16.setDisabledIcon(new ImageIcon(getClass().getResource("../../appmemorama/recursos/"+matrizJuego[3][3]+".jpg")));
    ...
    public  void Ganar() {
        if(!bt1.isEnabled() && !bt2.isEnabled() && !bt3.isEnabled() && !bt4.isEnabled() && !bt5.isEnabled() && !bt6.isEnabled() && !bt7.isEnabled() && !bt8.isEnabled() && 
           !bt9.isEnabled() && !bt10.isEnabled() && !bt11.isEnabled() && !bt12.isEnabled()&& !bt13.isEnabled() && !bt14.isEnabled() && !bt15.isEnabled() && !bt16.isEnabled()) {
            parar();//Agregar antes del mensaje de ganar
     ...
     public void reiniciar(){
        ...
        acierto.setText("0");
        cargarMatrizImg();
        //opcional. Reinicia junto con el juego
        resetSeg();
        resetMin();
        resetHora();
        seguir();
    ...
    private void initComponents() {
        ...
        bt13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/appmemorama/recursos/0.jpg"))); // NOI18N
        ...
        bt14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/appmemorama/recursos/0.jpg"))); // NOI18N
        ...
        bt15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/appmemorama/recursos/0.jpg"))); // NOI18N
        ...
        bt16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/appmemorama/recursos/0.jpg"))); // NOI18N
    ...
    //Estos son los métodos que se necesita para el funcionamiento del cronometro
    @Override
    public void run() {
    ...
    public synchronized int getSeg() {
     ...
     private static class Incrementar extends Thread{
    private Dificil v;
    private int seg;
    private int min;
    private int hora;
  
    public Incrementar( Dificil v){
        this.v=v;
        seg = v.getSeg();
        min = v.getMin();
        hora = v.getHora(); 
