...
public class Facil extends javax.swing.JPanel implements Runnable {
   ...
   private MatrizDimension mJ= new MatrizDimension();
    ...
    public void cargarMatrizImg(){
         int [][] matrizJuego=mJ.matrizNivel(2,2);
    ...
    public  void Ganar() {
        if(!bt1.isEnabled() && !bt2.isEnabled() && !bt3.isEnabled() && !bt4.isEnabled()) {
            parar();
            JOptionPane.showMessageDialog(this, "Felicidades!!!  "+jugador+" superaste el nivel Fácil!!", "Ganador", JOptionPane.INFORMATION_MESSAGE);
        }
    } 
    ...
    private static class Incrementar3 extends Thread{
    private Facil v;
    private int seg;
    private int min;
    private int hora;
  
    public Incrementar3(Facil v){
        this.v=v;
        seg = v.getSeg();
        min = v.getMin();
        hora = v.getHora(); 
